...
2. **Field validation of the USB flow (0.6.0)** — run the manual test matrix (OK / bad password / plain stick / yank mid-run) on real readers before promoting to the prod OTA channel.
